# LocalCoopOnlinePlayer
  ...
  > 8. You should see a alert with an id that you need to send to friend. Send it through a medium(Email,SMS,etc) with the player you want to play the game with <br>
