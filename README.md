# LocalCoopOnlinePlayer
 ...
 #### Player 2 Steps:
  ...
  > 2. Input the id sent by other player through a medium(Email,SMS,etc) into the prompt.If the prompt is gone before you could input the id reload the page and repeat step 2.
